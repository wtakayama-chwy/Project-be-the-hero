...
/*
* PARAMETHERS
* 1) Query params: For (filters & paginations) Example: app.get('/users?name=Will) - Named Paramethers send on your route after "?"
* 2) Route params: For (identify resources) - resource = '/users/:id' - insomnia must search '/users/1'
* 3) Request Body: For (create or alterate a resource)
* Resource params: 
*/
